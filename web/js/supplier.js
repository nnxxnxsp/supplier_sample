$(document).ready(function () {
    $('.supplier-index')
        /* Bind select all check box check/uncheck action */
        .on('click', '.select-on-check-all', function (e) {
        ...
        /* Bind select all <a> tag click action */
        ...
        /* Bind deselect all <a> tag click action */
